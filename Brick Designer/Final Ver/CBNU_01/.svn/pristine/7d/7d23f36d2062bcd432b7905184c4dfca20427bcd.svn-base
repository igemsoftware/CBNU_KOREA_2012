...
namespace BrickDesigner
{
    public partial class Form_Update : Form
    {
        ...
        private void bt_Ok_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error", "Modify", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                if (MessageBox.Show("Do you want to modify?", "Modify", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
